...
package cn.com.argorse.common.view.tab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    public interface OnTabIconListener {
        int getPageIcon(int position);
    }

    private OnTabIconListener mIconListener;
    ...
    public void setCustomTabView(int layoutResId, OnTabIconListener listener, int tabViewIconId) {
        this.mTabViewLayoutId = layoutResId;
        this.mIconListener = listener;
        this.mTabViewIconId = tabViewIconId;
    }
    ...
    public View getBadgeView(int i) {
        return mTabStrip.getChildAt(i).findViewById(mTabViewTextViewId);
    }
