...
public enum ClientFactory {
    ...
    ClientFactory() {
        ...
        Cache cache = new Cache(new File(Constants.NET_DATA_PATH), 10 * 1024 * 1024);
    ...
    private void onHttpCertficates(int[] certficates, String[] hosts) {
        mBuilder.socketFactory(ClientHelper.getSSLSocketFactory(BaseApplication.context(), certficates));
