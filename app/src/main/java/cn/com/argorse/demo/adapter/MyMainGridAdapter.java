 ...
 */
public class MyMainGridAdapter<Object> extends ArrayAdapter<Object> {
    private LayoutInflater mInflater;
    private MainGridViewData mData;

    public MyMainGridAdapter(Context context, int resource, Object[] objects, MainGridViewData mData) {
